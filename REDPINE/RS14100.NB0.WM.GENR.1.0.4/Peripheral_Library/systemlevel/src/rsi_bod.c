...
/**
 * @fn        float RSI_BOD_PeriodicTriggerGetBatteryStatus(void) 
 * @brief     This API is used to get the battery level status Periodically
 * @return    returns the Voltage value
 * @par       Example 
 *             RSI_BOD_PeriodicTriggerGetBatteryStatus();
 */
