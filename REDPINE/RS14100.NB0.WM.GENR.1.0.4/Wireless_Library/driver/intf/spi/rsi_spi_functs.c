...
/*==============================================*/
/**
 * @fn           int16_t rsi_send_dummy_bytes(unit8_t *response) 
 * @brief        send dummy bytes   
...
/*==============================================*/
/**
 * @fn           int16_t rsi_send_read_message() 
...
/*==============================================*/
/**
 * @fn           int16_t rsi_send_write_message(uint16_t length) 
 * @brief        send write message   
 * @param[in]    uint16_t length;length of the message 
 * @param[out]   none
 * @return       none
 * @section description
 * This API is used to send dummy bytes  
...
/*==============================================*/
/**
* @fn            void rsi_wait_for_spi_slave_ready()            
 * @brief        waits for SPI slave ready status   
 * @param[in]    none
 * @param[out]   none
 * @return       none
 * @section description
...
/*==============================================*/
/**
 * @fn           void rsi_wait_for_spi_slave_idle() 
 * @brief        wait for spi slave idle status   
 * @param[in]    none
 * @param[out]   none
 * @return       none
 * @section description
