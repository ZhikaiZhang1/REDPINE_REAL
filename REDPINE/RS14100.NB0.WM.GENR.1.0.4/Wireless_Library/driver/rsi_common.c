    ...
    case RSI_COMMON_REQ_OPERMODE:
      {
        ...
        if ((((rsi_bytes4R_to_uint32(rsi_opermode->opermode) >> 16) & 0xFF) == RSI_OPERMODE_WLAN_BLE)  ||
            (((rsi_bytes4R_to_uint32(rsi_opermode->opermode) >> 16) & 0xFF) == RSI_OPERMODE_WLAN_BT_CLASSIC) ||
            (((rsi_bytes4R_to_uint32(rsi_opermode->opermode) >> 16) & 0xFF) == RSI_OPERMODE_WLAN_BT_DUAL_MODE))
        {
