...
int32_t rsi_ble_vendor_rf_type (uint8_t perf_mode,uint8_t duty_cycling)
{
    ...
    ble_vendor_rf_type.performance_mode = perf_mode;
    ble_vendor_rf_type.duty_cycling = duty_cycling;
  
    return rsi_bt_driver_send_cmd(RSI_BLE_VENDOR_SPECIFIC, &ble_vendor_rf_type, NULL);
}
