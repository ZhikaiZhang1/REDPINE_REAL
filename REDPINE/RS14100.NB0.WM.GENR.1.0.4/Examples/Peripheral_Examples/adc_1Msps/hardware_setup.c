 ...
 *
 * @section Description
 * This files contains example code for Sleep state with SRAM Retention from PS2 state. 16KB of SRAM is retained in this mode. 
 *
 *
 */
/*Includes*/
...
void hardware_setup()
{
  ...
  RSI_ULPSS_PeripheralDisable(ULPCLK,ULP_VAD_CLK);  /* disable vad clks */
