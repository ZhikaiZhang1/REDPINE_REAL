...
===============================================================================================
This example is for USART master configuration,it will sends and receives data in full 
duplex mode.
===============================================================================================
===============================================================================================
Environment
...
USART0_CLK_PIN (GPIO_10) :J1.15  <->           USART0_CLK_PIN  
USART0_TX_PIN  (GPIO_9)  :J1.13  <->           USART0_TX_PIN  
USART0_RX_PIN  (GPIO_8)  :J1.11  <->           USART0_RX_PIN  
...
->Ensure that before executing master code ,slave should be configured properly
===============================================================================================
Pass criteria
===============================================================================================
