...
;/*****************************************************************************/
;/*  Startup for IAR                                                          */
;/*  Version     V1.0 Date 2013-03-22 Initial                                 */
;/*  Version     V1.1 Date 2014-06-12 Add "NOROOT"                            */
;/*  Target-mcu  MB9bf56x                                                     */
;/*****************************************************************************/
                ...
                EXTERN  SystemInit
		EXTERN   RSI_Reset_Handler
        EXTERN  __iar_program_start
        ;EXTERN  __tx_PendSVHandler
        EXTERN  _tx_thread_context_save
        EXTERN  _tx_thread_context_restore
        ;EXTERN  _tx_timer_interrupt
        EXTERN  _tx_timer_interrupt1
        EXTERN  RSI_INTERRUPT_IRQ_HANDLER
	EXTERN  RSI_DMA_IRQHandler
        ;EXTERN HandlerC  /* Debug variable*/
        EXTERN RSI_UART_IRQHandler
        ;EXTERN rsi_m4_interrupt_isr
        ;EXTERN IRQ002_Handler
        ;EXTERN rsi_sspi_event_handler
	PUBLIC  __vector_table
        ...
        PUBLIC  __Vectors_Size
                ...
                DATA
__vector_table  DCD     0x2000;sfe(CSTACK)               ; Top of Stack
                DCD     0x300001;Reset_Handler             ; Reset
                DCD     NMI_Handler               ; NMI
