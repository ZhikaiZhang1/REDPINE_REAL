 ...
 *
 *  @brief : This file contains example application for AES encryption and decryption
 *
 *  @section Description  This file contains example application to encrypt and decrypt the data using AES 
 *
 *
 */
