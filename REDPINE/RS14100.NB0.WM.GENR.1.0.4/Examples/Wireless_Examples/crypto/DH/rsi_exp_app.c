 ...
 *
 *  @brief : This file contains example application for computing the exponentiation value
 *
 *  @section Description  This file contains example application for calculating the exponentiation value 
 *
 *
 */
