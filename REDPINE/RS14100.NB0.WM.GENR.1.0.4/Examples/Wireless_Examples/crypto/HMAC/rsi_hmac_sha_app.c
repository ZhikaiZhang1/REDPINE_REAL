 ...
 *
 *  @brief : This file contains example application for computing hmac-sha digest 
 *
 *  @section Description  This file contains example application for computing hmac-sha digest 
 *
 *
 */
