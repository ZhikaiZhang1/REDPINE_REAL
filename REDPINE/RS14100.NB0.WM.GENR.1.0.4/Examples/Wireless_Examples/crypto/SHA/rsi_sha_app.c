 ...
 *
 *  @brief : This file contains example application for sha digest computation
 *
 *  @section Description  This file contains example application for computing the digest for the given input 
 *
 *
 */
