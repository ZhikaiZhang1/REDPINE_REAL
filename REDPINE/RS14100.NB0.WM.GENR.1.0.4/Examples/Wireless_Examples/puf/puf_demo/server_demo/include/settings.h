...
#define XREALLOC(p,n,h,t)  _XREALLOC(p,n,h,t); \
                          ...
                          dbg_printf_val_obe_final_dec(dbg_max_taken); \
					      dbg_printf_obe_final("\r\n"); 
#define XFREE(p,h,t)   _XFREE(p,h,t); \
						    dbg_printf_val_obe_final(p); \
                            dbg_printf_obe_final(" "); \
					        dbg_printf_obe_final(__func__); \
...
/* Micrium will use Visual Studio for compilation but not the Win32 API */
    ...
    #define XSTRLEN            lib_strlen
    #define XSTRNCPY           lib_strncpy
    #define XSTRNCMP           lib_strncmp
    #define XSTRSTR            lib_strstr
    #define XSTRNSTR           lib_strnstr
    #define XMEMSET(x, y, z)   lib_memset_value(x, y, z)
    #define XMEMCPY            lib_memcpy
    #define XMEMCMP            lib_memcmp
    #define XMEMMOVE           XMEMCPY
