...
#define XMALLOC(x, y, z)  crypto_rom_bss_ptr->malloc(x, y, z, __func__)
#define XREALLOC(w, x, y, z) crypto_rom_bss_ptr->realloc(w, x, y, z, __func__)
#define XFREE(x, y, z)    crypto_rom_bss_ptr->free(x, y, z, __func__)
