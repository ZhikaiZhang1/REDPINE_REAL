 ...
 *
 *  @brief : This file contains example application for sntp client functionality 
 *
 *  @section Description  This file contains example application for sntp client functionality 
 *
 *
 */
