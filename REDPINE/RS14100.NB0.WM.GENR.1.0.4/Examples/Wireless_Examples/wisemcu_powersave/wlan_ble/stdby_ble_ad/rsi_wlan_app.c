 ...
 *
 *  @brief : This file contains example application for coex power save in wlan_ble_advertising
 *
 *  @section Description  This file contains example application for coex power save in wlan_ble_advertising
 *
 *
 */
/**
...
#define REMOTE_IP_ADDRESS 0x640AA8C0
 ...
 rsi_common_cb_t *rsi_common_cb = rsi_driver_cb->common_cb;
  ...
  switch(rsi_wlan_app_cb.state)
  {
	...
	status = rsi_config_ipaddress(RSI_IP_VERSION_4, RSI_STATIC, (uint8_t *)&ip_addr, (uint8_t *)&network_mask, (uint8_t *)&gateway, NULL, 0, 0);
        ...
        rsi_wlan_app_cb.state = RSI_WLAN_M4_PWR_STATE; 
				break;
      }
	  case RSI_WLAN_M4_PWR_STATE:
      { 
#ifdef RSI_M4_INTERFACE     
				if(rsi_common_cb->power_save.power_save_enable == 1)
				{
