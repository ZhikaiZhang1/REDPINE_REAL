 ...
 *
 *  @brief : This file contains example application for coex power save in wlan_bt_connected
 *
 *  @section Description  This file contains example application for coex power save in wlan_bt_connected
 *
 *
 */
/**
