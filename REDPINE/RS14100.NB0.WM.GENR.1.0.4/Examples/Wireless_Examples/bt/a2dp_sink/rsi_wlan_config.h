...
#define RSI_TCP_IP_BYPASS            1 //RSI_DISABLE

//! TCP/IP feature select bitmap for selecting TCP/IP features    
#define RSI_TCP_IP_FEATURE_BIT_MAP  1 //(TCP_IP_FEAT_DHCPV4_CLIENT)

//! To set custom feature select bit map 
#define RSI_CUSTOM_FEATURE_BIT_MAP  0

//! To set Extended custom feature select bit map 
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP   (EXT_FEAT_256K_MODE  | (3 << 28))
