...
//! for STA+BT+BLE mode data transfer currently not supported
#define STA_BT_BLE_MODE         1
  ...
  switch(rsi_wlan_app_cb.state)
  {
    ...
    case RSI_WLAN_UNCONNECTED_STATE:
      {  
        ...
        status = rsi_wlan_connect((int8_t *)SSID, SECURITY_TYPE, NULL);
