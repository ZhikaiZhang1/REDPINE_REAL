 ...
 *
 *  @brief : This file contains application to explain hoew to bring up wlan , bt and ble protocols
 *
 *  @section Description  This file contains wlan ,bt and ble tasks execution in loop
 *
 *
 */
...
int32_t rsi_wlan_ap_bt_ble_app(void)
{
  ...
  status = rsi_wireless_init(RSI_WLAN_STA_MODE, RSI_WLAN_BT_CLASSIC_LE_MODE);
  if(status != RSI_SUCCESS)
  {
    return status;
  }
