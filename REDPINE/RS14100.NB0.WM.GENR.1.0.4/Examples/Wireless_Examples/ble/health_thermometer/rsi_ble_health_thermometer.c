 ...
 *  received from the GATT client in server case
 *
 */
...
static uint32_t rsi_ble_add_health_thermometer_serv (void)
{
  ...
  rsi_ble_add_service (new_uuid, 4, 60, &new_serv_resp);
      ...
      case RSI_BLE_GATT_WRITE_EVENT:
        {
          ...
          rsi_ble_set_local_att_value (temp_mgmt_hndl, 5, data);
        }
        break;
    }
  }
