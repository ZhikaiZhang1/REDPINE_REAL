 ...
 *
 *  @brief : This file contains example application for setting data length.
 *
 *  @section Description  This application connects as a Central and can be used to set data length.
 *
 */
