 ...
 *
 *  @brief : This file contains example application for BLE LR and 2MBPS.
 *
 *  @section Description  This application upadte the phy rates .
 *
 */
  ...
  status = rsi_device_init(RSI_LOAD_IMAGE_I_FW);
	...
	while(1)
	{
        ...
        rsi_6byte_dev_address_to_ascii (str_addr, rsi_app_connected_device.dev_addr);
				...
				status = rsi_ble_setphy(str_addr, 1/* tx_phy */, 2/*rx_phy */, 0 /* coded_phy */);
				if(status != RSI_SUCCESS)
				{
					return status;
				}
