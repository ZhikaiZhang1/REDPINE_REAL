/**
 * @file   rsi_ble_proximity_reporter.c 
 * @version 0.1
 * @date    09 May 2017
 *
 ...
 *
 *  @brief : This file contains example application for BLE Proximity Profile
 *
...
static uint32_t rsi_ble_add_proximity_serv (void)
{
  ...
  uint8_t    maxvalue = TX_MAX_VALUE;
	...
	rsi_ble_add_service (new_uuid, 1, 60, &new_serv_resp);
...
//	int8_t   data[20] = {0};
  ...
  adv[4] = 9;
  strcpy (&adv[5],RSI_BLE_APP_PROXIMITY_REPORTER);
