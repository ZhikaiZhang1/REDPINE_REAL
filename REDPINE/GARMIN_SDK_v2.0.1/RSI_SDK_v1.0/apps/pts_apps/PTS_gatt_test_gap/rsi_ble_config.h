...
#if (GAP_BROB_BCST_BV_01_C || GAP_DISC_NONM_BV_01_C || GAP_DISC_GENM_BV_01_C \
    || GAP_CONN_NCON_BV_01_C || GAP_CONN_NCON_BV_02_C || GAP_CONN_NCON_BV_03_C )
#define RSI_BLE_ADV_TYPE                              UNDIR_NON_CONN
#elif (GAP_BROB_BCST_BV_02_C)
#define RSI_BLE_ADV_TYPE                              UNDIR_SCAN
#elif (GAP_DISC_NONM_BV_02_C  || GAP_DISC_GENM_BV_02_C)
#define RSI_BLE_ADV_TYPE                              UNDIR_CONN
#elif (GAP_CONN_DCON_BV_01_C)
#define RSI_BLE_ADV_TYPE                              DIR_CONN_LOW_DUTY_CYCLE
#elif (GAP_DISC_LIMM_BV_01_C)
#define RSI_BLE_ADV_TYPE                              (LIMITED_ADV + UNDIR_NON_CONN)
#elif (GAP_DISC_LIMM_BV_02_C)
#define RSI_BLE_ADV_TYPE                              (LIMITED_ADV + UNDIR_CONN)
#else
#define RSI_BLE_ADV_TYPE                              UNDIR_CONN
#endif
#if 1
...
#define RSI_BLE_ADV_DIR_ADDR                          "00:1B:DC:F2:1C:54"  
...
/* Advertising will be visible for some predfiend time only
 * mententioned in lim_adv_timeout in Core SPec
 * */
#define LIMITED_ADV                                   0x40
//!Advertising flags
...
#if (GAP_BROB_OBSV_BV_01_C)
#define RSI_BLE_SCAN_TYPE                             SCAN_TYPE_PASSIVE
#elif (GAP_DISC_LIMP_BV_01_C || GAP_DISC_LIMP_BV_02_C || GAP_DISC_LIMP_BV_03_C || GAP_DISC_LIMP_BV_04_C || GAP_DISC_LIMP_BV_05_C)
#define RSI_BLE_SCAN_TYPE                             SCAN_TYPE_LIM_ACTIVE
#elif (GAP_DISC_GENP_BV_01_C || GAP_DISC_GENP_BV_02_C || GAP_DISC_GENP_BV_03_C || GAP_DISC_GENP_BV_04_C || GAP_DISC_GENP_BV_05_C) 
#define RSI_BLE_SCAN_TYPE                             SCAN_TYPE_GEN_ACTIVE
#else
#define RSI_BLE_SCAN_TYPE                             SCAN_TYPE_ACTIVE
#endif
#define RSI_BLE_SCAN_FILTER_TYPE                      SCAN_FILTER_TYPE_ONLY_WHITE_LIST

#define LE_NORMAL_SCANNING                            0x01
#define SCAN_TYPE_LIM_ACTIVE                          0x81
#define SCAN_TYPE_GEN_ACTIVE                          0x81

#define SCAN_TYPE                                     LE_NORMAL_SCANNING
//!Scan status
#define RSI_BLE_START_SCAN                            0x01
#define RSI_BLE_STOP_SCAN                             0x00
#define RSI_BLE_START_LIMITED_SCAN                    0x81
