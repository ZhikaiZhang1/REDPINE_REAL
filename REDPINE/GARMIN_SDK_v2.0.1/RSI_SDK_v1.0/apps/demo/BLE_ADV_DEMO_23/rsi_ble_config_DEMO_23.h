...
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_RSI_BLE_CONFIG_BLE_ADV_DEMO_H_
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_RSI_BLE_CONFIG_BLE_ADV_DEMO_H_
...
#define MAX_NUM_OF_SLAVES       3

#define BLE_PERIPHERAL_MODE_ENABLE      1

/***********************************************************************************************************************************************/
//! BLE_4 APP CONFIG defines
/***********************************************************************************************************************************************/

#define RSI_SEL_ANTENNA                RSI_SEL_INTERNAL_ANTENNA//RSI_SEL_EXTERNAL_ANTENNA

#define RSI_BLE_LOCAL_NAME             (void *)"REDPINE"
#define RSI_ADV_DATA_NAME			   "RSI_BLE_TEST_APP__4"
...
#define RSI_BLE_ADV_TYPE                             UNDIR_CONN //UNDIR_NON_CONN// UNDIR_CONN
...
#define  RSI_BLE_ADV_INT_MIN                           0x00a0  //0x800         //0xa0 is for 100ms, 0x800 for 1.28sec
#define  RSI_BLE_ADV_INT_MAX                           0x00a0 //0x800
#define  RSI_BLE_ADV_CHANNEL_MAP                       0x07

//!To set the advertising data to connect with an Android device
#define BLE_ADV_DATA_PAYLOAD                           0
...
#define RSI_BLE_PWR_INX                               30 // 30 for 0dBm and 63 for 4dBm
