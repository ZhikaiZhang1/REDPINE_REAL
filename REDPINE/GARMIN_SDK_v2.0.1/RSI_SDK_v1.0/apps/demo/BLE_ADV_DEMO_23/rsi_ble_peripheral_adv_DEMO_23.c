/**
 * @file    rsi_ble_peripheral_adv_DEMO_23.c
 * @version 0.1
 * @date    xx Feb 2019
 *
 ...
 *
 *  @brief : This file contains example application for BLE peripheral advertising.
 *
 *  @section Description  This application serves as a BLE peripheral.
 *
 */
