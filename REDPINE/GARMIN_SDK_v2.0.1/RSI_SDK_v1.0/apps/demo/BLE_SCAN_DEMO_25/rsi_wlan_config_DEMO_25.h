/**
 * @file         rsi_wlan_config_DEMO_25.h
 * @version      0.1
 * @date          13 Feb 2019 *
 ...
 */
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_WLAN_CONFIG_BLE_SCAN_H_
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_WLAN_CONFIG_BLE_SCAN_H_
...
#else
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP  (EXT_FEAT_LOW_POWER_MODE | EXT_FEAT_XTAL_CLK_ENABLE | EXT_FEAT_320K_MODE)  //EXT_FEAT_LOW_POWER_MODE
#endif
