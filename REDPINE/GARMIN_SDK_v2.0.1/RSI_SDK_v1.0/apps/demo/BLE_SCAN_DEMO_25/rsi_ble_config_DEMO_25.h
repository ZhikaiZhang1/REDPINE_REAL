 ...
 *
 */
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_BLE_CONFIG_BLE_SCAN_H_
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_BLE_CONFIG_BLE_SCAN_H_
...
//! To ebnable data transfer in BLE
#define DATA_TRANSFER_ENABLE            1
...
//! Maximum number of devices to be notified.
#define MAX_NUM_OF_NOTIFIED_DEVICES     6 //10
#endif
...
//! User configurations
/************************************************************************************************************/
#define RSI_BLE_LOCAL_NAME             (void *)"WYZBEE_PERIPHERAL"
