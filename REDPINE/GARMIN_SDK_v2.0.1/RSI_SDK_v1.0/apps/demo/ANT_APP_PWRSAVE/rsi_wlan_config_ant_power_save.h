/*
 * rsi_wlan_config_ant_power_save.h
 *
 *  Created on: 18-Feb-2019
 *      Author: test
 */

#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_ANT_APP_PWRSAVE_RSI_WLAN_CONFIG_ANT_POWER_SAVE_H_
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_ANT_APP_PWRSAVE_RSI_WLAN_CONFIG_ANT_POWER_SAVE_H_
...
#define BT_EDR_2MBPS_ENABLE  0
#define ENABLE_POWER_SAVE  RSI_ENABLE
...
#if ENABLE_1P8V
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP  (EXT_FEAT_XTAL_CLK_ENABLE | EXT_FEAT_256K_MODE | EXT_FEAT_1P8V_SUPPORT)
#else
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP  (EXT_FEAT_XTAL_CLK_ENABLE | EXT_FEAT_256K_MODE)
#endif
#else
//! To set wlan feature select bit map
...
#define TCP_RX_WINDOW_SIZE_CAP            10               //@ TCP RX Window size - 64K (44 * 1460)
...
#endif
#endif /* SAPIS_EXAMPLES_RSI_DEMO_APPS_ANT_APP_PWRSAVE_RSI_WLAN_CONFIG_ANT_POWER_SAVE_H_ */
