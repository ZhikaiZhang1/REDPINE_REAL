...
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_CONFIGWIFI_SSL_RX_THROUGHPUT_H
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_CONFIGWIFI_SSL_RX_THROUGHPUT_H
...
#define SERVER_IP_ADDRESS							"192.168.2.3"  //! 192.168.2.3 //! Server IP
#define SSL               							1              //! Enable/Disable SSL
#define LOAD_CERTIFICATE  							1              //! Load certificate to device flash //! Certificate could be loaded once and need not be loaded for every boot up
...
#define RSI_TCP_IP_FEATURE_BIT_MAP   	(TCP_IP_FEAT_DHCPV4_CLIENT | TCP_IP_FEAT_SSL | TCP_IP_FEAT_EXTENSION_VALID)  //! TCP/IP feature select bitmap for selecting TCP/IP features
...
/*=======================================================================*/
#define PLL_MODE              0
#define RF_TYPE               1 //! 0 - External RF 1- Internal RF(use if not using external antenna) //! applicable only when feature_frame is used
...
/***********************************************************************************************************************************************/
#endif
#endif /* SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_CONFIGWIFI_SSL_RX_THROUGHPUT_H */
