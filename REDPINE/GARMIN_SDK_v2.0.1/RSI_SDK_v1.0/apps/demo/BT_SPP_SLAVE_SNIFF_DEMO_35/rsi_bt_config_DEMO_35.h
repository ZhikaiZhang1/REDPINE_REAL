 ...
 *
 */
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_BT_CONFIG_BT_SPP_SLAVE_SNIFF_H_
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_BT_CONFIG_BT_SPP_SLAVE_SNIFF_H_
...
#define RSI_BT_LOCAL_NAME             "BT_SPP_SLAVE_SNIFF_TEST"
