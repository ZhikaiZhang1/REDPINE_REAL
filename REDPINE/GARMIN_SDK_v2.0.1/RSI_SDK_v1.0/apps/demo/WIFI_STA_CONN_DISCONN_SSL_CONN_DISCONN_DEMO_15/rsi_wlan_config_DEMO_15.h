 ...
 * @file         rsi_wlan_config_DEMO_15.h
 * @version      0.1
 * @date         15 Aug 2015
 *
 ...
 *
 */
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_CONFIG_WIFI_STA_CONN_DISCONN_SSL_CONN_DISCONN_H
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_CONFIG_WIFI_STA_CONN_DISCONN_SSL_CONN_DISCONN_H
/*=======================================================================*/
//  ! INCLUDES
/*=======================================================================*/
...
/***********************************************************************************************************************************************/
//! WIFI_STA_CONN_DISCONN_SSL_CONN_DISCONN APP CONFIG defines
/***********************************************************************************************************************************************/
#define SECURE_CON_DISCON 							0
#define TCP_TLS_CON_DISCON 							1
#define RSI_APP_BUF_SIZE        					1600
#define SSID               							"A2DPTEST1"          // Enter SSID of AP to connect
...
#define DEVICE_PORT									5001              //! Module Port
#define SERVER_PORT        							5001              //! Server Port number
#define SERVER_IP_ADDRESS							"192.168.2.3"  //"13.250.3.61" //0x0302A8C0    //! 198.168.2.3
#define SSL               							1                //! Enable/Disable SSL
...
#define RSI_TCP_IP_FEATURE_BIT_MAP   	(TCP_IP_FEAT_DHCPV4_CLIENT | TCP_IP_FEAT_SSL)   //! TCP/IP feature select bitmap for selecting TCP/IP features
...
/*=======================================================================*/
#if ENABLE_1P8V
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP  (EXT_FEAT_256K_MODE | EXT_FEAT_1P8V_SUPPORT)
#else
...
#define RSI_BG_SCAN_ENABLE          	RSI_DISABLE         //! RSI_ENABLE or RSI_DISABLE BG scan
...
#define RSI_ACTIVE_SCAN_DURATION        20                  //! Active scan duration
#define RSI_PASSIVE_SCAN_DURATION      	30                  //! Passive scan duration
...
#define RSI_JOIN_FEAT_BIT_MAP	   RSI_JOIN_FEAT_QUICK_JOIN                        //! RSI_JOIN_FEAT_STA_BG_ONLY_MODE_ENABLE or RSI_JOIN_FEAT_LISTEN_INTERVAL_VALID//!
...
/***********************************************************************************************************************************************/
#endif
#endif //!@ SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_CONFIG_WIFI_STA_CONN_DISCONN_SSL_CONN_DISCONN_H
