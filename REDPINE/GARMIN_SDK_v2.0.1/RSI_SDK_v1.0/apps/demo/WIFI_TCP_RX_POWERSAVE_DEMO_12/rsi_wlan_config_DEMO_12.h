 ...
 * @file         rsi_wlan_config_WIFI_4_1.h
 * @version      0.1
 * @date         13 Nov 2018
 *
 ...
 *
 */
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_CONFIG_WIFI_TCP_RX_POWERSAVE_H
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_CONFIG_WIFI_TCP_RX_POWERSAVE_H
/*=======================================================================*/
//  ! INCLUDES
/*=======================================================================*/
...
/***********************************************************************************************************************************************/
//! WIFI_TCP_RX_POWERSAVE APP CONFIG defines
/***********************************************************************************************************************************************/
#define RSI_APP_BUF_SIZE        					1600
#define THROUGHPUT_EN								1
#define UAPSD_POWER_SAVE                            1
...
#define RSI_TCP_IP_FEATURE_BIT_MAP   	(TCP_IP_FEAT_DHCPV4_CLIENT | TCP_IP_FEAT_EXTENSION_VALID)        //! TCP/IP feature select bitmap for selecting TCP/IP features
...
/*=======================================================================*/
#if ENABLE_1P8V
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP  (EXT_FEAT_LOW_POWER_MODE | EXT_FEAT_XTAL_CLK_ENABLE | EXT_FEAT_256K_MODE | EXT_FEAT_1P8V_SUPPORT)
#else
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP  (EXT_FEAT_LOW_POWER_MODE | EXT_FEAT_XTAL_CLK_ENABLE | EXT_FEAT_256K_MODE)
#endif
...
#endif /* SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_CONFIG_WIFI_TCP_RX_POWERSAVE_H */
