/**
 * @file         rsi_wlan_config_DEMO_16.h
 * @version      0.1
 * @date         13 Aug 2018
 *
...
#define REQ_THRUPT_IN_MBPS                    		5 //! 1Mbps - 1; 5Mbps - 5 ; 10Mbps - 10
...
#define RSI_TCP_IP_FEATURE_BIT_MAP   	(TCP_IP_FEAT_DHCPV4_CLIENT)                                     //! TCP/IP feature select bitmap for selecting TCP
#define RSI_EXT_TCPIP_FEATURE_BITMAP  0

#define RSI_CONFIG_FEATURE_BITMAP     0                                                               //! To set config feature select bit map
...
#define RSI_MULTIPROBE                 	RSI_DISABLE   //! Multiprobe
...
#define RSI_TIMEOUT_VALUE         	1500               //! roaming hysteresis value
