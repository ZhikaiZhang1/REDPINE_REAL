/**
 * @file    rsi_wlan_sta_bgscan__DEMO_14.c
 * @version 0.1
 * @date    13-Nov-2018
 *
...
#endif
{
	...
	case RSI_WLAN_CONNECTED_STATE:
	{
		...
		{
		    rsi_wlan_app_cb.state = RSI_WLAN_PWRSAVE_STATE;
			LOG_PRINT("wlan powersave state\n");
		}
		LOG_PRINT("BGScan Initiated...\n");
	}
	case RSI_WLAN_PWRSAVE_STATE:
#ifdef RSI_WITH_OS
    while(1);
#endif  
		break;
