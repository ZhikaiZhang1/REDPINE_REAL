 ...
 * @file         rsi_wlan_config_DEMO_14.h
 * @version      0.1
 * @date         13 Nov 2018
 *
 ...
 *
 */
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_CONFIG_WIFI_STA_BGSCAN_H
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_CONFIG_WIFI_STA_BGSCAN_H
/*=======================================================================*/
//  ! INCLUDES
/*=======================================================================*/
...
#define PERIODICITY_VAL       					     2                   //! BGSCAN periodicity - 2/10/30
...
/*=======================================================================*/
#if ENABLE_1P8V
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP  (EXT_FEAT_LOW_POWER_MODE | EXT_FEAT_XTAL_CLK_ENABLE | EXT_FEAT_1P8V_SUPPORT)
#else
...
#define RSI_BG_SCAN_SUPPORT     		RSI_ENABLE         //! RSI_ENABLE or RSI_DISABLE BG Scan support
#define RSI_BG_SCAN_ENABLE          	RSI_ENABLE         //! RSI_ENABLE or RSI_DISABLE BG scan
#define RSI_INSTANT_BG              	RSI_ENABLE         //! RSI_ENABLE or RSI_DISABLE instant BG scan
#define RSI_BG_SCAN_THRESHOLD          	10
#define RSI_RSSI_TOLERANCE_THRESHOLD   	4
#define RSI_BG_SCAN_PERIODICITY         PERIODICITY_VAL                 //! BG scan periodicity
#define RSI_ACTIVE_SCAN_DURATION       	20
#define RSI_PASSIVE_SCAN_DURATION      	30
...
#define RSI_SCAN_CHANNEL_BIT_MAP_2_4    (BIT(0) | BIT(5) | BIT(10))   //Scan channel selection of 1 ,6 & 11
...
/***********************************************************************************************************************************************/
#endif
#endif /* SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_CONFIG_WIFI_STA_BGSCAN_H */
