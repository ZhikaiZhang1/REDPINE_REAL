/**
 * @file    rsi_bt_page_scan_DEMO_33.c
 * @version 0.1
 * @date    xx Feb 2019
 *
 ...
 *
 *  @brief : This file contains example application for BT Classic Page Scan
 *
...
/*==============================================*/
/**
 * @fn         rsi_app_task_bt_page_scan
 * @brief      Keeps the BT Device in Page scan mode.
 * @param[in]  none
  * @return    none.
 * @section description
 * This function is used to test the Page scan mode functionality.
 */
int32_t rsi_app_task_bt_page_scan (void)
{
  ...
  rsi_bt_gap_register_callbacks(
	  ...
	  NULL,//rsi_bt_app_on_inq_resp_event,
	  ...
	  NULL,//rsi_bt_app_on_inq_complete_event,
  ...
  rsi_bt_set_eir_data (eir_data, strlen (RSI_BT_LOCAL_NAME) + 5);
	...
	//! start the connectability mode/ page scan mode
