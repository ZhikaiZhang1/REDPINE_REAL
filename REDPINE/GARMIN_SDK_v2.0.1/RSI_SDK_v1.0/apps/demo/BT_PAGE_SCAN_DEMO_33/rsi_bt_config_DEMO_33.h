 ...
 *
 */
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_BT_CONFIG_BT_PAGE_SCAN_H_
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_BT_CONFIG_BT_PAGE_SCAN_H_
...
//! application defines
#define RSI_BT_LOCAL_NAME             "BT_PAGE_SCAN"
