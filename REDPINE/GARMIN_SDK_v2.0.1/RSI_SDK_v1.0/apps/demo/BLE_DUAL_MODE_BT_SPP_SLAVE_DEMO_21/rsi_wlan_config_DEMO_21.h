 ...
 * @file         rsi_wlan_config_DEMO_21.h
 * @version      0.1
 * @date         15 Aug 2015
 *
 ...
 *
 */
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_WLAN_CONFIG_BLE_DUAL_MODE_BT_SPP_SLAVE
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_WLAN_CONFIG_BLE_DUAL_MODE_BT_SPP_SLAVE
...
#define RSI_BT_FEATURE_BITMAP			((BT_PWR_CTRL << 2) | (BT_PWR_INX << 3) | (BT_EDR_2MBPS_ENABLE << 8))   //! 'A2DP_ACCELERATOR_MODE_ENABLE' is disabled for SBC
#else
#define RSI_BT_FEATURE_BITMAP			((BT_PWR_CTRL << 2) | (BT_PWR_INX << 3) )   //! 'A2DP_ACCELERATOR_MODE_ENABLE' is disabled for SBC
#endif
#else
#if BT_EDR_3MBPS_DISABLE
#define RSI_BT_FEATURE_BITMAP			((BT_EDR_2MBPS_ENABLE << 8))   //! 'A2DP_ACCELERATOR_MODE_ENABLE' is disabled for SBC
#else
#define RSI_BT_FEATURE_BITMAP			(0)   //! 'A2DP_ACCELERATOR_MODE_ENABLE' is disabled for SBC
#endif
#endif
#endif
/*=======================================================================*/
...
#endif
#endif //!@ SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_WLAN_CONFIG_BLE_DUAL_MODE_BT_SPP_SLAVE
