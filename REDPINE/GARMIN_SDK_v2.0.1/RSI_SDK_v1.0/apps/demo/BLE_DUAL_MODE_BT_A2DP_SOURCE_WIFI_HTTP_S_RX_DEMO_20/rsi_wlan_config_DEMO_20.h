 ...
 * @file         rsi_wlan_config_DEMO_20.h
 * @version      0.1
 * @date         15 Aug 2015
 *
 ...
 */
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_WLAN_CONFIG_BLE_DUAL_MODE_BT_A2DP_SOURCE_WIFI_HTTP_S_RX_H
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_WLAN_CONFIG_BLE_DUAL_MODE_BT_A2DP_SOURCE_WIFI_HTTP_S_RX_H
...
/***********************************************************************************************************************************************/
//! BLE_DUAL_MODE_BT_A2DP_SOURCE_WIFI_HTTP_S_RX APP CONFIG defines
/***********************************************************************************************************************************************/
...
#define SERVER_IP_ADDRESS  							"192.168.2.4"            //! Server IP address
...
#if ENABLE_1P8V
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP  (EXT_FEAT_384K_MODE | EXT_FEAT_LOW_POWER_MODE | EXT_FEAT_1P8V_SUPPORT)
#else
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP  (EXT_FEAT_384K_MODE | EXT_FEAT_LOW_POWER_MODE)
#endif
...
/*=======================================================================*/
#if ENABLE_1P8V
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP  (EXT_FEAT_XTAL_CLK_ENABLE | EXT_FEAT_384K_MODE | EXT_FEAT_LOW_POWER_MODE | EXT_FEAT_1P8V_SUPPORT)
#else
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP  (EXT_FEAT_XTAL_CLK_ENABLE | EXT_FEAT_384K_MODE | EXT_FEAT_LOW_POWER_MODE)
#endif
#endif
