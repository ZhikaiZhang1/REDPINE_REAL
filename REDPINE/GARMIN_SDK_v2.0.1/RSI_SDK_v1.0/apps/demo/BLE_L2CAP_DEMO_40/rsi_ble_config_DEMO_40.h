...
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_BLE_CONFIG_BLE_L2CAP_H
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_BLE_CONFIG_BLE_L2CAP_H
...
/***********************************************************************************************************************************************/
//! BLE_L2CAP_CBFC APP CONFIG defines
/***********************************************************************************************************************************************/
...
#define RSI_BLE_DEV_ADDR_TYPE                           LE_PUBLIC_ADDRESS //LE_PUBLIC_ADDRESS       //! Address type of the device to connect

#define RSI_BLE_DEV_ADDR                                "88:DA:1A:9E:BE:4D"     //! Address of the device to connect

#define RSI_REMOTE_DEVICE_NAME					         "rrr"                  //! Remote Device Name to connect



/***********************************************************************************************************************************************/
//! BLE_PERIPHERAL SAPI CONFIG DEFINES
/***********************************************************************************************************************************************/
...
/***********************************************************************************************************************************************/
#endif
#endif /* SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_BLE_CONFIG_BLE_PERIPHERAL_H */
