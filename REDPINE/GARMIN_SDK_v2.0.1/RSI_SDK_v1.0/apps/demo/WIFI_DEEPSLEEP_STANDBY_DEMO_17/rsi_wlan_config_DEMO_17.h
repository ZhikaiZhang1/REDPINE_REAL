/**
 * @file         rsi_wlan_config_DEMO_17.h
 * @version      0.1
 * @date          13 Nov 2018 *
 ...
 */
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_CONFIG_WIFI_DEEPSLEEP_STANDBY_H
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_CONFIG_WIFI_DEEPSLEEP_STANDBY_H
/*=======================================================================*/
//  ! INCLUDES
/*=======================================================================*/
...
#if ENABLE_1P8V
#define RSI_CUSTOM_FEATURE_BIT_MAP   	FEAT_CUSTOM_FEAT_EXTENTION_VALID
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP  (EXT_FEAT_1P8V_SUPPORT)
#else
...
#if (DP_SLEEP_WITH_RAM_RET || WLAN_STANDBY)
...
/***********************************************************************************************************************************************/
#endif
#endif /* SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_CONFIG_WIFI_DEEPSLEEP_STANDBY_H */
