...
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_WLAN_CONFIG_BT_EIR_SNIFF_SPP_SLAVE_H_
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_WLAN_CONFIG_BT_EIR_SNIFF_SPP_SLAVE_H_
...
#define BT_PWR_CTRL_DISABLE     1
#define BT_PWR_CTRL             1
#define BT_PWR_INDEX            3

#define BT_PWR_INX              10

#if BT_PWR_CTRL_DISABLE
#define RSI_BT_FEATURE_BITMAP		((BT_PWR_CTRL << 2) | (BT_PWR_INDEX << 3))
#else
...
#else
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP  (EXT_FEAT_XTAL_CLK_ENABLE | EXT_FEAT_320K_MODE)  //EXT_FEAT_LOW_POWER_MODE
#endif
...
/***********************************************************************************************************************************************/
#endif
#endif /* SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_WLAN_CONFIG_BT_EIR_SNIFF_SPP_SLAVE_H_ */
