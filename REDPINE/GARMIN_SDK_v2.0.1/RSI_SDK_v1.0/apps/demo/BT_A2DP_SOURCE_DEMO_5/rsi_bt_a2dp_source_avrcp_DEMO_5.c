/**
 * @file    rsi_bt_a2dp_source_avrcp_DEMO_5.c
 * @version 0.1
 * @date    13 Oct 2018
 *
...
//! start the ssp mode
	...
	status = rsi_ble_vendor_avdtp_stats_enable(AVDTP_STATS_ENABLE);
	if(status != RSI_SUCCESS)
	{
		return status;
	}
 ...
 */
int32_t rsi_app_task_bt_a2dp_source() {
	int32_t status = 0;
...
//				break;
		...
		case RSI_APP_EVENT_AVDTP_STATS: {
			...
			LOG_PRINT("Clock:0x%x, TxPoll:%d, TxNull:%d, RxPoll:%d, RxNull:%d\n",
					avdtp_stats.clock,avdtp_stats.tx_poll,avdtp_stats.tx_null,avdtp_stats.rx_poll,avdtp_stats.rx_null);
			LOG_PRINT("dm1_tx:%d, dm1_rx:%d, dm3_tx:%d, dm3_rx:%d, dm5_tx:%d, dm5_rx:%d\n",
					avdtp_stats.dm1_pkt[0],avdtp_stats.dm1_pkt[1],avdtp_stats.dm3_pkt[0],avdtp_stats.dm3_pkt[1],avdtp_stats.dm5_pkt[0],avdtp_stats.dm5_pkt[1] );
			LOG_PRINT("dh1_tx:%d, dh1_rx:%d, dh3_tx:%d, dh3_rx:%d, dh5_tx:%d, dh5_rx:%d\n",
					avdtp_stats.dh1_pkt[0],avdtp_stats.dh1_pkt[1],avdtp_stats.dh3_pkt[0],avdtp_stats.dh3_pkt[1],avdtp_stats.dh5_pkt[0],avdtp_stats.dh5_pkt[1] );
			LOG_PRINT("2dh1_tx:%d, 2dh1_rx:%d, 2dh3_tx:%d, 2dh3_rx:%d, 2dh5_tx:%d, 2dh5_rx:%d\n",
					avdtp_stats.edr_2dh1_pkt[0],avdtp_stats.edr_2dh1_pkt[1],avdtp_stats.edr_2dh3_pkt[0],avdtp_stats.edr_2dh3_pkt[1],avdtp_stats.edr_2dh5_pkt[0],avdtp_stats.edr_2dh5_pkt[1] );
			LOG_PRINT("3dh1_tx:%d, 3dh1_rx:%d, 3dh3_tx:%d, 3dh3_rx:%d, 3dh5_tx:%d, 3dh5_rx:%d\n",
					avdtp_stats.edr_3dh1_pkt[0],avdtp_stats.edr_3dh1_pkt[1],avdtp_stats.edr_3dh3_pkt[0],avdtp_stats.edr_3dh3_pkt[1],avdtp_stats.edr_3dh5_pkt[0],avdtp_stats.edr_3dh5_pkt[1] );
			LOG_PRINT("CRC_Fail:%d, Retries:%d, HDR_Err:%d, Seq_Rep:%d\n",
					avdtp_stats.no_of_crc_fail,avdtp_stats.no_of_retries,avdtp_stats.no_of_hdr_err,avdtp_stats.no_of_seq_repeat);
			LOG_PRINT("ACK_DELAY- LT_10:%d, LT_20:%d, LT_30:%d, LT_40:%d, LT_50:%d, LT_60:%d, LT_70:%d, LT_80:%d, LT_90:%d, LT_100:%d, GT_100:%d \n\n",
					avdtp_stats.ack_delay[0],avdtp_stats.ack_delay[1],avdtp_stats.ack_delay[2],avdtp_stats.ack_delay[3],avdtp_stats.ack_delay[4],avdtp_stats.ack_delay[5],avdtp_stats.ack_delay[6],avdtp_stats.ack_delay[7],avdtp_stats.ack_delay[8],avdtp_stats.ack_delay[9],avdtp_stats.ack_delay[10]);
