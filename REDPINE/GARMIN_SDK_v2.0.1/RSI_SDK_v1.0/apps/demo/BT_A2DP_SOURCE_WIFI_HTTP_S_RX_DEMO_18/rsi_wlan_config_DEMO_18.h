 ...
 * @file         rsi_wlan_config_DEMO_18.h
 * @version      0.1
 * @date         15 Aug 2015
 *
...
#define SERVER_IP_ADDRESS  							"192.168.0.2"            //! Server IP address
...
#define RSI_EXT_TCPIP_FEATURE_BITMAP   	EXT_TCP_IP_BI_DIR_ACK_UPDATE //EXT_TCP_IP_WINDOW_DIV
...
#define RSI_EXT_TCPIP_FEATURE_BITMAP   	EXT_TCP_IP_BI_DIR_ACK_UPDATE //EXT_TCP_IP_WINDOW_DIV                                                                                      //! To set custom feature select bit map
#define RSI_CUSTOM_FEATURE_BIT_MAP   	FEAT_CUSTOM_FEAT_EXTENTION_VALID                                             //! To set Extended custom feature select bit map
