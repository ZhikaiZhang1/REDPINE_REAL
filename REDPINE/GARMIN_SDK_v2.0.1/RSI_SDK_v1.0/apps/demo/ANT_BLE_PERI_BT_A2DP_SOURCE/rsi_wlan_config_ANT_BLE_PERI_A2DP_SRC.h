 ...
 */
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_RSI_WLAN_CONFIG_BLE_ADV_BT_A2DP_SOURCE_H
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_RSI_WLAN_CONFIG_BLE_ADV_BT_A2DP_SOURCE_H
...
#define RSI_EXT_TCPIP_FEATURE_BITMAP   	0                                                                            //! To set custom feature select bit map 
