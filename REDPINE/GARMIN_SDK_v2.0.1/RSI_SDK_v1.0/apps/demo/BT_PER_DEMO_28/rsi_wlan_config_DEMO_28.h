/**
 * @file         rsi_wlan_config_DEMO_28.h
 * @version      0.1
 * @date         15 Feb 2019
 *
 ...
 *
 */
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_WLAN_CONFIG_BT_PER_H_
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_WLAN_CONFIG_BT_PER_H_
