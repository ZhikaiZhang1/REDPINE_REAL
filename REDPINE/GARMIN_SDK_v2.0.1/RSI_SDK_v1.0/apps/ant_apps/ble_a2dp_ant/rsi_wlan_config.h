...
#define ENABLE_POWER_SAVE         RSI_DISABLE 
//! To enable concurrent mode
#define CONCURRENT_MODE                      RSI_DISABLE
#define EXT_FEAT_XTAL_CLK_ENABLE                 BIT(22)

//! QSPI 80Mhz Clock control.
#define EXT_FEAT_QSPI_80MHZ_CLK_ENABLE				0
...
#define RSI_CONFIG_FEATURE_BITMAP     0                                                                            //! To set custom feature select bit map 
...
/*=======================================================================*/
#if ENABLE_1P8V
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP  (EXT_FEAT_256K_MODE | EXT_FEAT_1P8V_SUPPORT | (EXT_FEAT_QSPI_80MHZ_CLK_ENABLE << 8))
#else
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP  (EXT_FEAT_320K_MODE | (EXT_FEAT_QSPI_80MHZ_CLK_ENABLE << 8))
#endif
#endif
