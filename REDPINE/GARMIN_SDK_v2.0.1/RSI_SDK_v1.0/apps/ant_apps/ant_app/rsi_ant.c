 ...
 *
 *  @brief : This file contains example application for ANT application.
 *
 *  @section Description  This application serves as a ANT Sample PER Transmit and Receive Mode.
 *
 */
